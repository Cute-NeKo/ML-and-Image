...
class RSMaskDataSet(Dataset):
    def __init__(self):
        ...
        # load meadow image
        dir_name_train = self.listdir(r'E:\DataSet\NWPU-RESISC45-dataset\NWPU-RESISC45\NWPU-RESISC45\meadow')
        self.data_list_train = dir_name_train
        print('Read ' + str(len(self.data_list_train)) + ' images')

        data_route_mask = r'E:\DataSet\mask\mask_test\testing_mask_dataset'
    ...
    def __getitem__(self, item):
        ...
        mask = self.transform_mask(mask.convert('RGB'))
        mask = 1 - mask
